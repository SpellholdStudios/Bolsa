...
Bolsa es un nuevo vendedor, que como bien dice el nombre, vende contenedores varios, bolsas para los objetos que no te entren en el inventario, cinturones de munición y un Bastón de Magus muy útil, además de objetos normales.
...
- Idea: Alexa.
- Programación y desarrollo: Mhoram.
...
- Traducción al italiano por ilot.
- Líneas extras y revisión por Miloch.
- Traducción al francés por Elgaern (de d'Oghmatiques)
- Gracias Lollorian (traducción al inglés) y White Agnus (revisión)
...
----------------------------
- Traducción al francés por Elgaern.
...
-----------------------------
- Traducción al inglés gracias a Lollorian.
- White Agnus por la revisión.
